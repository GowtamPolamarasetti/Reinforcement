...
def evaluate_usdmxn_ppo():
    ...
    print(f"Evaluating PPO on USD/MXN ({num_days} Days)...")
    ...
    plt.plot(curve, label='PPO USD/MXN', color='blue')
    plt.title('PPO Performance on USD/MXN')
    plt.xlabel('Days')
    plt.ylabel('Capital')
    plt.yscale('log')
    plt.grid(True, linestyle='--', alpha=0.6)
    plt.legend()
    plt.savefig('RL_Agent_Final/equity_curve_usdmxn_ppo.png')
    print("Saved plot to RL_Agent_Final/equity_curve_usdmxn_ppo.png")
