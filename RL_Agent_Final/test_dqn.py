...
def evaluate():
    model_path = "RL_Agent_Final/models_dqn/final_model_dqn"
    ...
    plt.plot(equity_curve, label='DQN Agent Equity', color='blue')
    plt.title('Equity Curve - DQN Agent')
    plt.xlabel('Trading Days')
    plt.ylabel('Capital ($)')
    plt.grid(True, linestyle='--', alpha=0.6)
    plt.legend()
    plt.savefig('RL_Agent_Final/equity_curve_dqn.png')
    print("Equity curve saved to 'RL_Agent_Final/equity_curve_dqn.png'")
    ...
    plt.savefig('RL_Agent_Final/monthly_heatmap_dqn.png')
    print("Monthly heatmap saved to 'RL_Agent_Final/monthly_heatmap_dqn.png'")
